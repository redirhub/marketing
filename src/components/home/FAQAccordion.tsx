...
export const FAQAccordion = ({ items }: FAQAccordionProps) => {
  const itemValue = (item: FAQItem, index: number) => item._key || `faq-${index}`;
  const [openItem, setOpenItem] = useState<string | null>(itemValue(items[0], 0) || null);
