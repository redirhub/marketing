...
import { Drawer, Accordion, Box, Flex, Text, VStack, HStack, Icon, Button } from "@chakra-ui/react";
            ...
            <Flex justify="space-between" align="center">
              ...
              <Drawer.CloseTrigger asChild>
                <Box
                  ...
                  cursor={"pointer"}
                  borderRadius={"md"}
                  _hover={{ backgroundColor: "interactive.blueHover" }}
                >
                  <FaTimes size={20} />
                </Box>
              </Drawer.CloseTrigger>
                                ...
                                <Box borderTop="1px solid" borderColor="whiteAlpha.200" mt={2}>
                                  {item.megaMenu.footer.map((footerItem: any, fIdx: number) => (
                                    <Link
                                      ...
                                      target={footerItem?.target === "blank" ? "_blank" : undefined}
                                    >
                                      <HStack py={3} px={5} gap={3} _hover={{ bg: "whiteAlpha.100" }}>
                                        {footerItem.icon &&
